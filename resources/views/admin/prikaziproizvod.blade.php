        ...
        <div class="container" align="center">
          ...
          <table>
            <tr style="background-color: #557A95;">
              ...
              <td style="padding:20px">Osvježi</td>
              <td style="padding:20px">Obriši</td>
            </tr>
            ...
            <tr align="center" style="background-color: #5D5C61; align-items:center ;">
              ...
              <td> <a class="btn btn-primary" href="{{url('osvjeziproizvod', $proizvod->id)}}">Osvježi</td>
              <td> <a class="btn btn-danger" href="{{url('obrisiproizvod',$proizvod->id)}}">Obriši</td>
            </tr>
